...
#                      Main Class                      #
########################################################
# This class is used as the Medbot's utility class and
# has several functions in connection with data and
...
class MedbotUtility:
    ...
    def determine_pulse_rate_rating(self, age, pulse_rate, return_int = False):
        if(age <= 1):
            if(pulse_rate < 100):
                rating = 'Low'
            elif(pulse_rate < 160):
    ...
    def determine_blood_pressure_rating(self, systolic, diastolic, return_int = False):
        ...
        if(return_int):
            if(rating == 'Low'):
                ...
                rating = 2.25
            elif(rating == 'High Stage 1'):
                rating = 2.5
            elif(rating == 'High Stage 2'):
                rating = 2.75
            elif(rating == 'Hypertensive Crisis'):
                rating = 3
        return rating

    def determine_blood_saturation_rating(self, blood_saturation, return_int = False):
