...
def determine_pulse_rate_rating(age, pulse_rate, return_int = False):
    if(age <= 1):
        if(pulse_rate < 100):
            rating = 'Low'
        elif(pulse_rate < 160):
...
def determine_blood_pressure_rating(systolic, diastolic, return_int = False):
...
def determine_blood_saturation_rating(blood_saturation, return_int = False):
